...
# Only enforce HTTPS/secure-cookie behavior once DEBUG is off — otherwise local
# dev over plain http:// would redirect-loop / drop cookies.
if not DEBUG:
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'workspaces.context_processors.onboarding_tour',
            ],
        },
    },
]
